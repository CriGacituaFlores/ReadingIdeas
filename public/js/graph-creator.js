document.onload = (function(d3, saveAs, Blob, undefined){
    ...
    // initial node data
    var nodes = [{title: "IF1", id: 0, x: xLoc, y: yLoc},
                 {title: "IF2", id: 1, x: xLoc-100, y: yLoc + 200},
                 {title: "IF3", id: 2, x: xLoc+100, y: yLoc + 200}];
    ...
    $("#argmap").droppable({
       drop: function() {
           console.log("soy argmap: me tiraron algo encima");
       }
    });
    ...
    $(".draggables li").draggable({
        ...
        start: function (e) {
            ...
            console.log("dragged: " + DragDropManager.dragged);
        },
        ...
        stop: function (e, ui) {
            console.log("soy draggable: me tiraron");
