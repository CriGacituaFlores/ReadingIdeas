...
let GraphCreator = function (callbacks, svg, nodes, edges, messages) {
    var thisGraph = this;
    thisGraph.idct = 0;
    ...
    thisGraph.callbacks = callbacks;
    thisGraph.defaultMessages = messages;
    ...
    d3.select("#download-input").on("click", function () {
        ...
        thisGraph.edges.forEach(function (val, i) {
            saveEdges.push({source: val.source.id, target: val.target.id, comment: thisGraph.defaultMessages.blank_comment});
        });
...
GraphCreator.prototype.circleMouseUp = function (d3node, d) {
    ...
    if (mouseDownNode !== d) {
        ...
        var newEdge = {source: mouseDownNode, target: d, comment: thisGraph.defaultMessages.blank_comment};
...
GraphCreator.prototype.updateGraph = function () {
    ...
    pathGroupsEnter.append("circle")
        ...
        .attr("fill", "red")
        .on("mousedown", function (d) {
            thisGraph.callbacks.commentClick({
                'edge': d,
                'x': d3.mouse(this)[0],
                'y': d3.mouse(this)[1]
            });
...
GraphCreator.prototype.isEdgeCommented = function (e) {
    let thisGraph = this;
    return e.comment != thisGraph.defaultMessages.blank_comment;
}
